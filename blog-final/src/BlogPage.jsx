                ...
                <div className="row justify-content-center pt-5">
                    <div className="col-lg-8 rounded-3 p-5" id='addbox'>
                        ...
                        <form action="" onSubmit={handleSubmit}>
                            ...
                            <h6>Choose Hotel:</h6>
                            <input type="file" className='form-control bg-transparent text-white' value={image} name="" id="" onChange={(e) => setImage(e.target.value)} />
                            ...
                            <div className='d-flex'>
                                <div>
                                    <h6>Date(from):</h6>
                                    <input type="date" className='form-control mb-4 bg-transparent text-white me-4' style={{ width: "275px" }} onChange={(e) => setDate} />
                                </div>
                                <div>
                                    <h6>To:</h6>
                                    <input type="date" className='form-control mb-4 bg-transparent text-white' style={{ width: "275px" }} onChange={(e) => setDate} />
                                </div>
                                <div className='ms-4'>
                                    <h6>Members</h6>
